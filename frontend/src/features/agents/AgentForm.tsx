        ...
        <CardContent className="grid gap-5">
          ...
          <section className="grid gap-2">
            <div className="space-y-1">
              ...
              <p className="text-sm text-slate-500">Capture what the agent is for and what it should optimize for.</p>
            </div>
            <label className="grid gap-2 text-sm font-medium text-slate-700">
              Description
              <Textarea
          ...
          <fieldset className="grid gap-3">
            ...
            <p className="text-sm text-slate-500">Allow only the functions this agent should be able to execute at runtime.</p>
