...
it('renders sidebar with data-testid', () => {
  render(
    <AgentSidebar agents={agents} selectedAgentId={null} onSelect={vi.fn()} onNew={vi.fn()} />,
  );
...
it('calls onSelect with the agent when an agent is clicked', async () => {
  ...
  render(
    <AgentSidebar agents={agents} selectedAgentId={null} onSelect={onSelect} onNew={vi.fn()} />,
  );
